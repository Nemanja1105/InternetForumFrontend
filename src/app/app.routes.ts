...
export const routes: Routes = [
    ...
    { path: '', component: PageTemplateComponent, canActivate: [isLoginGuard], children: [{ path: 'user', component: UsersComponent }, { path: 'forum', component: ForumComponent }, { path: 'comments/:id', component: ForumCommentsComponent }, { path: '', pathMatch: 'full', redirectTo: '/forum' }] },
